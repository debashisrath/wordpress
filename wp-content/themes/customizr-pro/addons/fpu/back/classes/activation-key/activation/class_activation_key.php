...
class TC_activation_key {
  ...
  public $transients;
	...
	function __construct ( $args ) {
          ...
          $this -> strings = array(
              'enter-key' => __( 'Enter your Activation Key.', 'edd-theme-updater' ),
              ...
              'license-key-is-active' => __( 'Key is valid.', 'edd-theme-updater' ),
    ...
    function tc_plug_license_page() {
        ...
        <div class="wrap">
            <?php
              ...
              $this -> tc_plug_license_page_content( $license, $status, $message );
            ?>
        </div> <!-- .wrap -->
        <?php
    }
    ...
    function tc_plug_license_page_content( $license, $status, $message ) {
        ?>
