    ...
    function tc_generates_responsive_image_settings() {
      ...
      return array(
           "{$plug_option_prefix}[tc_resp_fp_img]"  =>  array(
                'default'     => 0,
                'control'     => 'TC_controls_fpu' ,
                'label'       => __( "Enable the WordPress responsive image feature for the Featured Pages images" , $this -> plug_lang ),
                'notice'      => __( 'This feature has been introduced in WordPress v4.4+ (dec-2015), and might have minor sides effects on some of your existings images. Check / uncheck this option to safely verify that your images are displayed nicely.', $this -> plug_lang ),
                'section'     => 'tc_fpu' ,
                'type'        => 'checkbox' ,
                'priority'    => 20
          )
