...
<?php if ( is_front_page() ) { ?>
    <div class="">
       <h3 class="scom-h2-home-tag" style="">Our Videos</h2>
    </div>
...
<div class="row">
  <div class="span12">
    ...
    <p class="home_view_more"><a href="">View More</a></p>
  </div>
</div>
...
<style type="text/css">
.scom-h2-home-tag {
  text-align: center;font-size: 28px;color: #eb1d1f;font-weight: 700;
}
h4.peopleabout.scom-h2-home-tag {
    margin-top: 60px;
    margin-bottom: 30px;
}
  .home_view_more {
  ...
  .persionname {float: center; color:#ef0000; margin-top: 20px;  font-style: normal;}
  .home_view_more a {
    color: #ef0000;
    font-size: 16px;
  }
